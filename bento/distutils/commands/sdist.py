...
class sdist(old_sdist):
    ...
    def run(self):
        ...
        cmd = dist.global_context.retrieve_command(cmd_name)
        run_cmd_in_context(dist.global_context, cmd, cmd_name, cmd_argv,
                cmd_context_klass, dist.run_node, dist.top_node, dist.pkg)
