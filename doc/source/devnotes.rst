...
Justification for the concepts:
	...
	- OutputRegistry: this is an adapter to InstdalledSectionRegistry. This
	  is needed to provide a common interfance to InstalledSectionRegistry,
	...
	- InstalledSectionRegistry: at that point, any "entity" is simply a
	  list of files + just enough metadata for install. Nodes must exists
	  on the fs.
